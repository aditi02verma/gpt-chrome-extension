  ...
  if (message.type === "ASK_CHATGPT") {
    ...
    fetch("http://localhost:3000", {
      ...
      .catch((error) => {
        restoreCursor();
        alert(
          "Error. Make sure you're running the server by following the instructions on https://github.com/adii02verma/gpt-chrome-extension. Also make sure you don't have an adblocker preventing requests to localhost:3000."
        );
